        ...
        <div className='ammenities__container'>
            ...
            <div className='ammenities__images'>
                <div className="single__ammenity">
                    <img alt='' src='https://pm1.narvii.com/6041/880e894abc46342473f11838a65ee9571a0f5c27_hq.jpg'/>
                    <h4>Temples</h4>
                </div>
                <div className="single__ammenity">
                    <img alt='' src='https://www.denofgeek.com/wp-content/uploads/2016/01/millennium-falcon.jpg'/>
                    <h4>Space ships</h4>
                </div>
                <div className="single__ammenity">
                    <img alt='' src='https://d3eys52k95jjdh.cloudfront.net/wp-content/uploads/2019/07/cropped-He_Tatooine_21.jpg'/>
                    <h4>Desert igloos</h4>
                </div>
                <div className="single__ammenity">
                    <img alt='' src='https://api.time.com/wp-content/uploads/2019/12/cute-star-wars-characters-07.jpg'/>
                    <h4>Pets allowed</h4>
                </div>
            </div>
        </div>
